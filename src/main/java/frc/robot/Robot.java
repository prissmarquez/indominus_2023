...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    SmartDashboard.putNumber("chasis_rightEncoder", chasis_rightEncoder.getPosition());
    SmartDashboard.putNumber("chasis_leftEncoder", chasis_leftEncoder.getPosition());
